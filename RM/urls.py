...
urlpatterns = [
    ...
    #
    url(r'^tables$', my_order.index_table, name='home_table'),
    url(r'^table/new/$', my_order.new_table, name='new_table'),
    url(r'^table/delete/(?P<table_id>\d+)/$', my_order.destroy_product, name='delete_table'),
    #
